...
export default function getProccessedForecastData() {
...
function getForecastCurrentData(current) {
  const {
    temp_c: tempC, temp_f: tempF, condition, uv, feelslike_c: feelsLikeC, feelslike_f: feelsLikeF,
  } = current;
  const {
    humidity, wind_kph: windKph, wind_dir: windDir, vis_km: visKm, pressure_mb: pressureMb,
  } = current;
  return {
    tempC, tempF, condition, uv, feelsLikeC, feelsLikeF, humidity, windKph, windDir, visKm, pressureMb,
  };
}
